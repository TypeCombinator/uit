...
using irwbt_apple_t = uit::irsbt<&rsbt_apple::right, &rsbt_apple::left, &rsbt_apple::size>;
...
TEST(iwbt_test, insert_unique3) {
    uit::irsbt<&rsbt_apple::right, &rsbt_apple::left, &rsbt_apple::size, std::less<rsbt_apple>>
        tree{};
    rsbt_apple a0{500, 0};
    rsbt_apple a1{501, 1};
    rsbt_apple a2{502, 2};
