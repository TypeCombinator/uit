...
*/
#ifndef _LINUX_IRBT_H
#define _LINUX_IRBT_H

#include <stddef.h>

// Storing color information on the parent pointer is an UB! But, umm...
// Copy from linux kernel 6.13, files are as follows:
// lib/rbtree.c
...
#define WRITE_ONCE(dst,value)  (dst) = (value)
